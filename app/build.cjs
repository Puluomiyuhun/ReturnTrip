...
const files=['第一章-明天见.md','第二章-等一会儿.md','第三章-带上东西.md','第四章-先下来.md','第五章-照片里的位置.md'];
...
nodes.end={id:'end',end:true,text:'前五章 · 完'};
const story={id:'huicheng-chapters-v11',version:1,title:'回程',start:ids[0],chapters,nodes};
