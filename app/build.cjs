...
const files=['第一章-明天见.md','第二章-等一会儿.md','第三章-门开着.md','第四章-先别挂.md','第五章-你听一下.md'];
...
const story={id:'huicheng-chapters-v09',version:1,title:'回程',start:ids[0],chapters,nodes};
